...
void configure_dev() {
	...
	unsigned char snd0020[2] = {0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0900, 0x01b0, snd0020, 2, 0);

	unsigned char snd0021[5] = {0xab, 0xa9, 0x0f, 0xa4, 0x55};
	libusb_control_transfer(devh, 0x40, 0xbd, 0x0000, 0x3300, snd0021, 5, 0);
	...
	unsigned char snd0128[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1000, snd0128, 8, 0);

	unsigned char snd0129[8] = {0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1000, snd0129, 8, 0);

	unsigned char snd0130[8] = {0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0130, 8, 0);

	unsigned char snd0131[8] = {0x00, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0131, 8, 0);

	unsigned char snd0132[8] = {0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0132, 8, 0);

	unsigned char snd0133[8] = {0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0133, 8, 0);

	unsigned char snd0134[8] = {0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0134, 8, 0);

	unsigned char snd0135[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0135, 8, 0);

	unsigned char snd0136[8] = {0x00, 0x04, 0x00, 0x00, 0x00, 0x7f, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0136, 8, 0);

	unsigned char snd0137[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0137, 8, 0);

	unsigned char snd0138[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0138, 8, 0);

	unsigned char snd0139[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1004, snd0139, 8, 0);

	unsigned char snd0140[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1100, snd0140, 8, 0);

	unsigned char snd0141[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1240, snd0141, 8, 0);

	unsigned char snd0142[8] = {0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1100, snd0142, 8, 0);

	unsigned char snd0143[8] = {0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1240, snd0143, 8, 0);

	unsigned char snd0144[8] = {0x61, 0xa8, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1104, snd0144, 8, 0);

	unsigned char snd0145[8] = {0x1f, 0x40, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1244, snd0145, 8, 0);

	unsigned char snd0146[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1104, snd0146, 8, 0);

	unsigned char snd0147[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1244, snd0147, 8, 0);

	unsigned char snd0148[8] = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1108, snd0148, 8, 0);

	unsigned char snd0149[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1108, snd0149, 8, 0);

	unsigned char snd0150[8] = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1248, snd0150, 8, 0);

	unsigned char snd0151[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1248, snd0151, 8, 0);

	unsigned char snd0152[8] = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x110c, snd0152, 8, 0);

	unsigned char snd0153[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x110c, snd0153, 8, 0);

	unsigned char snd0154[8] = {0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1110, snd0154, 8, 0);

	unsigned char snd0155[8] = {0x00, 0x00, 0x00, 0x00, 0x01, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1110, snd0155, 8, 0);

	unsigned char snd0156[8] = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x124c, snd0156, 8, 0);

	unsigned char snd0157[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x124c, snd0157, 8, 0);

	unsigned char snd0158[8] = {0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1250, snd0158, 8, 0);

	unsigned char snd0159[8] = {0x00, 0x00, 0x00, 0x00, 0x01, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1250, snd0159, 8, 0);

	unsigned char snd0160[8] = {0x00, 0x00, 0x10, 0x11, 0x00, 0x00, 0x1f, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1124, snd0160, 8, 0);

	unsigned char snd0161[8] = {0x00, 0x00, 0x10, 0x11, 0x00, 0x00, 0x1f, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1264, snd0161, 8, 0);

	unsigned char snd0162[8] = {0x01, 0x0f, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1128, snd0162, 8, 0);

	unsigned char snd0163[8] = {0x01, 0x0f, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1268, snd0163, 8, 0);

	unsigned char snd0164[8] = {0x00, 0x1f, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1134, snd0164, 8, 0);

	unsigned char snd0165[8] = {0x00, 0x1f, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1274, snd0165, 8, 0);

	unsigned char snd0166[8] = {0x01, 0x10, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x112c, snd0166, 8, 0);

	unsigned char snd0167[8] = {0x01, 0x10, 0x00, 0x00, 0x1f, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x126c, snd0167, 8, 0);

	unsigned char snd0168[8] = {0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1f, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x112c, snd0168, 8, 0);

	unsigned char snd0169[8] = {0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1f, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x126c, snd0169, 8, 0);

	unsigned char snd0170[8] = {0x00, 0x00, 0x11, 0x11, 0x00, 0x00, 0x1f, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1268, snd0170, 8, 0);

	unsigned char snd0171[8] = {0x00, 0xe0, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1130, snd0171, 8, 0);

	unsigned char snd0172[8] = {0x00, 0xe0, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1270, snd0172, 8, 0);

	unsigned char snd0173[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x113c, snd0173, 8, 0);

	unsigned char snd0174[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x127c, snd0174, 8, 0);

	unsigned char snd0175[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x113c, snd0175, 8, 0);

	unsigned char snd0176[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x127c, snd0176, 8, 0);

	unsigned char snd0177[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1140, snd0177, 8, 0);

	unsigned char snd0178[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1280, snd0178, 8, 0);

	unsigned char snd0179[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1140, snd0179, 8, 0);

	unsigned char snd0180[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xff};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1280, snd0180, 8, 0);

	unsigned char snd0181[8] = {0x10, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x00};
	libusb_control_transfer(devh, 0x40, 0xbc, 0x0001, 0x1138, snd0181, 8, 0);
